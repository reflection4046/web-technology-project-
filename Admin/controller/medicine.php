...
function validateform()
{
	...
	else if(!document.frmmedicine.medicinename.value.match(alphaExp))
	{
	...
	else if(document.frmmedicine.description.value == "")
	{
     ...
     else if(!document.frmmedicine.description.value.match(alphaspaceExp))
	{
    ...
    else if(document.frmmedicine.select.value == "" )
	{
		...
		document.frmmedicine.select.focus();
		return false;
	}
